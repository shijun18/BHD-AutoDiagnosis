'''
Inference: https://github.com/pytorch/vision/blob/master/torchvision/models/video/resnet.py
'''
...
__all__ = ['r3d_18', 'mc3_18', 'r2plus1d_18','se_r3d_18','se_mc3_18']
...
class BasicStem(nn.Sequential):
    ...
    def __init__(self, input_channels=1):
        super(BasicStem, self).__init__(
            nn.Conv3d(input_channels, 64, kernel_size=(3, 7, 7), stride=(1, 2, 2),
...
class R2Plus1dStem(nn.Sequential):
    ...
    def __init__(self, input_channels=1):
        super(R2Plus1dStem, self).__init__(
            nn.Conv3d(input_channels, 45, kernel_size=(1, 7, 7),
...
def r2plus1d_18(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _volume_resnet('r2plus1d_18',
                         pretrained, progress,
                         block=BasicBlock,
